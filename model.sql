...
(
  ...
  CONSTRAINT FK_NPTC_IT_PROTOCOLO_6 FOREIGN KEY (ID_PROTOCOLO_ITEM) REFERENCES USRDBVAH.TB_NPTC_PROTOCOLO (ID),
  CONSTRAINT FK_NPTC_IT_PROTOCOLO_7 FOREIGN KEY (CD_EVO_ENF) REFERENCES DBAMV.EVO_ENF (CD_EVO_ENF)
);
...
DROP TABLE USRDBVAH.TB_NPTC_TIPO_DOC_MANUAL;
...
DROP SEQUENCE USRDBVAH.SEQ_NPTC_TIPO_DOC_MANUAL;
