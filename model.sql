...
CREATE TABLE USRDBVAH.TB_NPTC_PROTOCOLO_FILHO
(
  ID_PAI NUMBER(*),
  ID_FILHO NUMBER(*),
  CONSTRAINT PK_NPTC_PROTOCOLO PRIMARY KEY (ID_PAI, ID_FILHO),
  CONSTRAINT FK_NPTC_PROTOCOLO_FILHO_1 FOREIGN KEY (ID_PAI) REFERENCES USRDBVAH.TB_NPTC_PROTOCOLO (ID),
  CONSTRAINT FK_NPTC_PROTOCOLO_FILHO_2 FOREIGN KEY (ID_PAI) REFERENCES USRDBVAH.TB_NPTC_PROTOCOLO (ID)
);
...
DROP TABLE USRDBVAH.TB_NPTC_PROTOCOLO_FILHO;
